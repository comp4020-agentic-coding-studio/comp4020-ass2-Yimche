...
and you fix it before you leave. We look at structure, naming, and history as
engineering, not decoration.

## Afterwards

You leave with a repository that reads like it was meant to be read, and a list
of the places it still does not.
