...
teachers:
  - idris-fenn
spec:
  - you have a working status bar wired to real system state
  - every module left in the bar is one you glanced at within a day
...
the empty space felt wrong. Anything you cannot defend comes out before you
leave.

## Afterwards

You leave with a bar that shows only what you look at, and a note of everything
you removed and how much you missed it, which is usually not at all.
